...
bounding rectangle) (Figure~\ref{fig:Representation of unfiltered points}).
By this method, we narrow down the geographic range of the tweets and mark up
them on the map. We can find that there are some points outside of the state.
Then we apply some spacial operator to filter them (Figure~\ref
{fig:Spatial operators}).
\begin{figure}[h]
    \centering
...
real tendency (Figure~\ref{fig:Distribution of tweets}~\ref
{fig:Distribution of tweets in Florida}~\ref{fig:Distribution in Los
Angeles}). 
\begin{figure}[h]
    \centering
