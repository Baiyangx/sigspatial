...
al.(2021)~\cite{kastrati2021deep} used a deep learning based sentiment analyser called ALBANA is
...
Among other logical approaches, there is a study~\cite{chakraborty2020sentiment} proposes the
